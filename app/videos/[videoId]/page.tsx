            ...
            <div className="flex flex-row gap-7">
                <div className="w-[420px] mt-6 ml-9">
                    <div className="aspect-[9/16] bg-gray-800 rounded-2xl overflow-hidden">
                        ...
                        >
                            Your old fucking browser cant run thisvideo
                        </video>
                    </div>
                </div>
                    ...
                    <div className="flex flex-col ml-5 mt-10">
                        ...
                        <div className="mt-10">
                            ...
                            <div className="w-110 mt-5 p-4 rounded-md bg-neutral-900/60 background-blur-sm border-gray-100">
                                <TypingAnimation typeSpeed={50} className="text-sm text-transparent bg-clip-text bg-gradient-to-r from-gray-300 via-gray-100 to-gray-400">
                                    {transcript || ""}
                                </TypingAnimation>
                            </div>
                        </div>
